...
uint8 CanFilterSet(uint8 port,uint8 filter_index,uint32 can_id_1,uint32 can_id_2)
{
	u32 tmp_u32_val;
	CAN_FilterInitTypeDef  CAN_FilterInitStructure;
...
void CAN1_RX0_IRQHandler(void)
{
	...
	CanRecMessage(1,tmp_id,(uint8*)can_msg.Data);
}
void CAN2_RX1_IRQHandler()
{
	...
	CanRecMessage(2, tmp_id, (uint8*)can_msg.Data);
}
